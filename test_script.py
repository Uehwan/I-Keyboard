...
os.system('python3 test.py --batch_size 1 --model unidirectional '
...
os.system('python3 test.py --batch_size 1 --model bidirectional '
          '--num_layer 2 --num_unit 64 --num_epoch 500 --num_epoch_decay 500 --print_freq 250 '
...
os.system('python3 test.py --batch_size 1 --model hierarchical '
          '--num_layer 2 --num_unit 64 --num_epoch 500 --num_epoch_decay 500 --print_freq 250 '
...
# Model 4. transformer
os.system('python3 test.py --batch_size 1 --model transformer '
          '--num_layer 3 --num_unit 32 --num_epoch 500 --num_epoch_decay 500 --print_freq 250 '
...
# Model 5. seq2seq
os.system('python3 test.py --batch_size 1 --model seq2seq_attention '
          '--num_layer 2 --num_unit 64 --num_epoch 500 --num_epoch_decay 500 --print_freq 250 '
          '--embedding_size 16 '
